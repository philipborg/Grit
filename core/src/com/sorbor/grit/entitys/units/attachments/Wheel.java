...
public class Wheel implements Attachment, Entity, Disposable{
	...
	@Override
	public void render() {
		sb.draw(tr[cFrame], lastPos.x, lastPos.y, tr[cFrame].getRegionWidth()/2, tr[cFrame].getRegionHeight()/2, tr[cFrame].getRegionWidth(), tr[cFrame].getRegionHeight(), 1, 1, rotation);
	}
